import { faChalkboardTeacher, faSchool, faUniversity, faUserGraduate } from "@fortawesome/free-solid-svg-icons";
...
function Education() {
    return (
        ...
        >
            ...
            <div className='row w-100'>
                <div className='col-12 col-lg-8 col-xl-6 text-white d-flex flex-column gap-5'>
                    <div className="w-100">
                        ...
                        <div className='d-flex flex-row justify-content-between align-items-center'>
                            <h3 className='display-7'>Sunway International Business School</h3>
